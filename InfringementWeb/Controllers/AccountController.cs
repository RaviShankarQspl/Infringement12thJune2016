...
namespace InfringementWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Set values of cookies if exists
            if (Request.Cookies["IASLoginEmail"] != null) ViewBag.LoginEmail = Request.Cookies["IASLoginEmail"].Value;
            if (Request.Cookies["IASPassword"] != null) ViewBag.Password = Request.Cookies["IASPassword"].Value;
            if (Request.Cookies["IASLoginEmail"] != null && Request.Cookies["IASPassword"] != null) ViewBag.remberme = "checked";
            //if (Request.Cookies["IASLoginEmail"] != null) ViewBag.rememberme = "checked";
            ViewBag.LoginVerification = "false";
        ...
        //    #region Remember Me
        //    // Set values of cookies if exists IASPassword
        //    if (Request.Cookies["IASLoginEmail"] != null) ViewBag.LoginEmail = Request.Cookies["IASLoginEmail"].Value;
        //    if (Request.Cookies["IASPassword"] != null) ViewBag.UserPassword = Request.Cookies["IASPassword"].Value;
        //    if (Request.Cookies["IASLoginEmail"] != null) ViewBag.Rememberme = "checked";
        //    #endregion
        //}
