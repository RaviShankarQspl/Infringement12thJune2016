...
namespace InfringementWeb.Controllers
{
    ...
    System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public ActionResult DownloadInfList()
        {
            ...
            {
                pictures1 = "";
                var ipayment = db.infringement_payment.Where(x => x.InfringementId == line.Id).Select(x => x.TransactionNumber).FirstOrDefault();
        ...
        [HttpPost]
        public ActionResult PayNow(List<InfringementWeb.infringement> model, string Email, string InfringementIds, string Submit)
        {
            ...
            if (IdsToPay.Count > 0)
            {
                ...
                if (totalAmount > 0)
                {
                    ...
                    else
                    {
                        ...
                        var auth =
                            System.Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes("98!6tOii25GtT"));

                        var myRequest =
                            System.Net.WebRequest.Create("https://poliapi.apac.paywithpoli.com/api/Transaction/Initiate");
